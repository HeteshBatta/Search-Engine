...
{
   ofstream fout;
   fout.open(/home/hetesh/Desktop/backup/backupfile.txt);
   list *header = list_head;
   while(header!=NULL)
   {
...
{
   ifstream fin;
   fin.open(/home/hetesh/Desktop/backup/backupfile.txt);
   while()
}*/
void workOnNextUrl()
{
...
{
    str[0]='\0';
    char temp[100]="/home/hetesh/Desktop/sefiles/";
    char fno[100];
...
int findFileSize()
{
    ...
    stat("/home/hetesh/Desktop/se/temp.txt",&st); // temp.txt is the file where wget fetch the html
...
void copyFile()
{
      ...
      ifstream fin;
      ofstream fout;
      fin.open("/home/hetesh/Desktop/se/temp.txt");
      fout.open(str);
...
void getPage(char *url)
{
    ...
    strcat(urlbuffer,"/home/hetesh/Desktop/se/temp.txt ");
